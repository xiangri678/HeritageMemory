...
struct ARView_Ox : View {
    @State private var showingSAlert = false

    var body: some View {
        ZStack{
            ARViewContainer_Ox().edgesIgnoringSafeArea(.all)
...
struct ARViewContainer_Ox: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        // 请替换成牛
        let sceneOneAnchor = try! OxV8.load场景()
...
#if DEBUG
struct ARView_Ox_Previews : PreviewProvider {
