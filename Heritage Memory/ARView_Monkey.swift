...
struct ARView_Monkey : View {
    @State private var showingSAlert = false

    var body: some View {
        ZStack{
            ARViewContainer_Monkey().edgesIgnoringSafeArea(.all)
...
struct ARViewContainer_Monkey: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        let sceneOneAnchor = try! MonkeyV4.loadSceneOne()
...
#if DEBUG
struct ARView_Monkey_Previews : PreviewProvider {
