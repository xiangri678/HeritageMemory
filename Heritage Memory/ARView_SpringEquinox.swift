...
struct ARView02 : View {
    @State private var showingSAlert = false
    var body: some View {
        ZStack{
            ARViewContainer02().edgesIgnoringSafeArea(.all)
...
struct ARViewContainer02: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        let sceneOneAnchor = try! TheSpringEquinox.loadScene()
...
#if DEBUG
struct ARView02_Previews : PreviewProvider {
