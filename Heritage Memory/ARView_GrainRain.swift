...
struct ARView_GrainRain : View {
    @State private var showingSAlert = false

    var body: some View {
        ZStack{
            ARViewContainer_GrainRain().edgesIgnoringSafeArea(.all)
...
struct ARViewContainer_GrainRain: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        let sceneOneAnchor = try! GrainRain.load场景()
...
#if DEBUG
struct ARView_GrainRain_Previews : PreviewProvider {
