...
struct ARViewContainer_WakingOfInsects: UIViewRepresentable {
...
#if DEBUG
struct ARView_WakingOfInsects_Previews : PreviewProvider {
    static var previews: some View {
        ARView_WakingOfInsects()
    }
}
#endif
