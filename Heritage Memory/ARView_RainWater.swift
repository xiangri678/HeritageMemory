...
struct ARView_RainWater : View {
    @State private var showingSAlert = false

    var body: some View {
        ZStack{
            ARViewContainer_RainWater().edgesIgnoringSafeArea(.all)
...
struct ARViewContainer_RainWater: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        let sceneOneAnchor = try! RainWater.load场景()
...
#if DEBUG
struct ARView_RainWater_Previews : PreviewProvider {
