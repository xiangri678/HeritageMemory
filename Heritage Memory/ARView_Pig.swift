...
struct ARView_Pig : View {
    @State private var showingSAlert = false

    var body: some View {
        ZStack{
            ARViewContainer_Pig().edgesIgnoringSafeArea(.all)
...
struct ARViewContainer_Pig: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        let sceneOneAnchor = try! Pig.load场景()
...
#if DEBUG
struct ARView_PigPreviews : PreviewProvider {
